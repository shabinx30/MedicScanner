    ...
    return (
        <>
            <div className="mt-10 w-full flex gap-2 justify-center md:justify-between">
                <div className="p-4 w-[20em] rounded-xl bg-[#dafdff] dark:bg-[#0d3234] animate-pulse"></div>
                <div className="p-4 w-[10em] rounded-xl bg-[#dafdff] dark:bg-[#0d3234] animate-pulse"></div>
            </div>
            <section className="flex flex-col lg:flex-row w-full gap-4">
                <div className="flex flex-col min-h-full flex-1/3 bg-[#24868b] dark:bg-[#196165] rounded-2xl p-6">
                    <div className="flex items-center justify-between">
                        <p className="p-4 w-1/2 bg-[#dafdff] dark:bg-[#0d3234] animate-pulse rounded-2xl"></p>

                        <p className="p-4 w-1/3 bg-[#dafdff] dark:bg-[#0d3234] animate-pulse rounded-2xl"></p>
                    </div>
                    <h3 className="mt-4 p-8 w-1/3 bg-[#dafdff] dark:bg-[#0d3234] animate-pulse rounded-2xl"></h3>
